...
<?php 
	include "koneksi.php";
	$id=$_GET['id'];
	$query_mysql = mysqli_query($koneksi, "SELECT * FROM formulir WHERE id='$id'")or die(mysqli_error());
	$nomor = 1;
	...
	<table width="500" height="300">
        ...
        <td> : &nbsp; <?php echo $data["department"]; ?></td>    			
          ...
          <option value="">Pilih Shift</option>
			...
			<tr>
				<td></td>
				<td><br/><input type="submit" value="Simpan" class="btn_a_style btn_skyblue"onclick="return confirm ('Apakah anda yakin ingin menyimpan data ini?')"></td>					
			</tr>				
		</table>
	</form></center>
	<?php } ?>
